...
public class ScrapController {
    ...
    public ResponseEntity<BaseResponse<ScrapResponse>> selectScrap(@RequestBody ScrapSelectRequest scrapSelectRequest) {
        ScrapResponse scrapResponse = scrapService.findOne(scrapSelectRequest);
    ...
    public ResponseEntity<BaseResponse> deleteScrap(@RequestBody ScrapDeleteRequest scrapDeleteRequest) {
        for(Long id : scrapDeleteRequest.getId()) {
